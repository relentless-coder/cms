function optinFunction(optinFactory) {
	...
	ctrl.subscriber = {};
	ctrl.info = {};
	ctrl.info.message = 'Hey, if you enjoyed this post, then I can drop you an email everytime I write a new post. Your information will not be shared with anyone.';
